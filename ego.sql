...
--
-- Host: 127.0.0.1
-- Generation Time: 2023-02-02 02:49:33
...
(10188, '猪肉', '[]', '122', '12', '1004', '冷饮冻食', '12', '', '', '2022-12-26 14:45:32', '', '<p>1233</p>', ''),
(10189, '牛肉', '[]', '11', '11', '1005', '蔬菜单品', '11', '', '', '2022-12-26 14:45:43', '', '<p>11</p>', '');
...
--
ALTER TABLE `project`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10190;
--
